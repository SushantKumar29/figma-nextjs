      ...
      <div className="mx-auto w-full max-w-full sm:max-w-8/10">
        ...
        >
          <div className="absolute inset-y-0 left-0 w-[60%]">
            ...
            />
            <div className="absolute inset-0" style={{ background: "rgb(63 156 242 / 79%);" }} />
          </div>
            ...
            <div className="w-full max-w-85 flex flex-col gap-px">
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-[14px] font-medium text-white">Phone</span>
                </div>
                <span className="text-[14px] font-bold text-white">+1 315 308 0901</span>
              </div>
              ...
              >
                ...
                <span className="text-[14px] font-bold text-white">sales@chromezy.com</span>
              </div>
            </div>
          </div>
          ...
          <div className="lg:hidden relative z-10 bg-[#e4eef8] mx-4 mb-5 rounded-[20px] px-6 py-8">
            <h3 className="text-[24px] font-black text-gray-900 mb-5">Let&apos;s Talk!</h3>
